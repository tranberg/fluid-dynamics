\section{Warm-up: poor man's approach to Fluid Dynamics (1-7)}
\begin{quote}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=.6\textwidth]{week1/leonardos-law}
    \caption{}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=.5\textwidth]{week1/aarhus-oe}
    \caption{}
    \label{fig:aarhus-oe}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=.7\textwidth]{week1/wake-flow}
    \caption{}
    \label{fig:wake-flow}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=.4\textwidth]{week1/near-field}
    \caption{}
    \label{fig:betz}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=.5\textwidth]{week1/two-turbines}
    \caption{}
